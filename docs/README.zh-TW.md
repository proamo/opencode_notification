...
> 目前版本：**v1.0.0-rc.2**（OpenCode Commander Web 控制台、遠端主動派工、多核心語音 STT、多主機 Hub-and-Spoke Gateway、節點 Agent、Telegram 互動按鈕與 AI 執行結論）。
> 目前狀態：Release Candidate 2，尚未發布 npm 公開版本。
